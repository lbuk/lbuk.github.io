...
<div class="col">
	<img class="col" src="{{ site.baseurl }}/img/space_ratio_chart.png" alt="Space Ratio Chart showing density variables FAR, H and DPH with corresponding Space Ratio values"/>
</div>
...
<div class="col">
	<img class="col" src="{{ site.baseurl }}/img/portfolio_spaceratio_example.png" alt="Example output of the spaceratio R package showing a Space Ratio Chart visualisation"/>
</div>
